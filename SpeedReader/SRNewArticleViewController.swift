...
class SRNewArticleViewController: NSViewController {
    ...
    func createArticleBasedOnFileURL(_ fileURL: URL) {
        ...
        var parseAttribute: String = NSPlainTextDocumentType
        
        if normalizedExtension == "rtf" {
            parseAttribute = NSRTFTextDocumentType
        } else if normalizedExtension == "doc" {
            parseAttribute = NSDocFormatTextDocumentType
        } else if normalizedExtension == "docx" {
            parseAttribute = NSWordMLTextDocumentType
        } else if normalizedExtension == "html"{
            parseAttribute = NSHTMLTextDocumentType
        } else if normalizedExtension == "webArchive" {
            parseAttribute = NSWebArchiveTextDocumentType
        }
        do {
            let attributedStringWithRtf:NSAttributedString = try NSAttributedString(url: fileURL, options: [NSDocumentTypeDocumentAttribute:parseAttribute], documentAttributes: nil)
